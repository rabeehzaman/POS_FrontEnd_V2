...
export function FloatingCart() {
  ...
  // Show button only when there are items OR when there's a last invoice to display
  if (cart.length === 0 && !lastInvoice) {
    return null
  }
        ...
        {isExpanded && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 h-full w-full max-w-md z-50 flex flex-col bg-background"
            >
