...
export async function GET(
  ...
  try {
    ...
    if (nameError || !mainProduct) {
      console.log('Product not found in history:', itemId)
    ...
    const response: ItemHistoryResponse = {
      ...
      itemName,
      isGrouped,
      relatedItems: isGrouped ? uniqueProductIds.filter(productId => productId !== itemId) : undefined,
      salesTransactions,
      purchaseTransactions
    }
    ...
    console.log('========== ITEM HISTORY FETCHED ==========\n')
